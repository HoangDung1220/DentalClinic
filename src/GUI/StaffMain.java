...
public class StaffMain extends JFrame {
	...
	public StaffMain(Staff s) {
		...
		labelDanhmuc = new JLabel("Patient Admission");
		...
		labelCure = new JLabel("Invoice Creator");
		...
		labelStatistic = new JLabel("Logout");
		...
		labelStatistic.setBounds(10, 197, 251, 37);
		labelStatistic.setIcon(new ImageIcon(SystemConstant.logout1));
		...
		lableAccount.setBounds(10, 150, 251, 37);
		...
		lbLogout.setBounds(10, 197, 40, 40);
		...
		lbChange.setBounds(10, 150, 40, 40);
