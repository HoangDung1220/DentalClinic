...
public class DoctorMain extends JFrame {
	...
	public DoctorMain(Staff s) {
		...
		labelCure = new JLabel("Medical Form Creator");
		...
		labelCure.setBounds(10, 56, 240, 37);
		...
		lableAccount.setBounds(10, 103, 251, 37);
		...
		lblNewLabel_2 = new JLabel("Logout");
		...
		lblNewLabel_2.setBounds(10, 150, 251, 37);
		lblNewLabel_2.setIcon(new ImageIcon(SystemConstant.logout1));
		...
		lbTreatment.setBounds(10, 56, 40, 40);
		...
		lbLogout.setBounds(10, 150, 40, 40);
		...
		lbChange.setBounds(10, 103, 40, 40);
