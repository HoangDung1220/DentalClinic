...
public class PanelDanhMucSort extends JPanel {


	public PanelDanhMucSort() {
		setSize(950, 405);
		setLayout(null);
		...
		panel.setBounds(89, 228, 145, 161);
		add(panel);
		...
		panel_1.setBounds(399, 39, 145, 161);
		add(panel_1);
		...
		panel_2.setBounds(696, 39, 145, 161);
		add(panel_2);
		...
		panel_3.setBounds(399, 228, 145, 161);
		add(panel_3);
		...
		panel_4.setBounds(696, 236, 145, 161);
		add(panel_4);
		...
		panel_5.setBounds(89, 39, 145, 161);
		add(panel_5);
