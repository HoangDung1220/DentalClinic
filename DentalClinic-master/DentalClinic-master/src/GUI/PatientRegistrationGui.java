...
public class PatientRegistrationGui extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
	  ...
	  public static void loadAllPatient() {
		   String header[] = {"Id", "Fullname", "Gender","Birthday","Phone","Address","Icard","Created_by","Create_date","Modified_by","Modified_date","Status"};
			...
			{   
				...
				for (int i=0;i<list.size();i++)
				{
					Patient p1=(Patient)list.get(i);
						...
						Vector data =new Vector();
						data.add(p1.getId());
						data.add(p1.getFullname());
						data.add(p1.getGender());
						data.add(p1.getBirthday());
						data.add(p1.getPhone());
						data.add(p1.getAddress());
						data.add(p1.getiCard());
						data.add(p1.getCreatedBy());
						data.add(p1.getCreatedDate());
						data.add(p1.getModifiedBy());
						data.add(p1.getModifiedDate());
						data.add(p1.getStatus());
