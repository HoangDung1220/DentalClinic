...
public class PanelNgiepVuSort extends JPanel {

	
	public PanelNgiepVuSort() {
		setSize(950, 404);
		setLayout(null);
		...
		Patient.setBounds(102, 99, 174, 192);
		add(Patient);
		...
		panel_1.setBounds(394, 99, 174, 192);
		add(panel_1);
		...
		panel_2.setBounds(678, 99, 174, 192);
		add(panel_2);
